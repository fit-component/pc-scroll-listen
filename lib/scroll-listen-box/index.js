...
var ScrollListenBox = function (_React$Component) {
    ...
    _createClass(ScrollListenBox, [{
            ...
            this.unsubscribe = this.props.store.subscribe(function () {
                switch (_this2.props.store.getState().LastAction.type) {
                    ...
                    case _actions.SET_NAIL_INFO:
                        _this2.nailArray = _this2.props.store.getState().Nail.infos;
                        break;
                }
            });
        }
        ...
        value: function componentDidMount() {
            ...
            this.$scrollSelf.on('DOMNodeInserted', function () {
                console.log(123);
            });
        }
    }, {
        ...
        value: function componentWillUnmount() {
            ...
            this.$scrollSelf.off('DOMNodeInserted', function () {
                console.log(123);
            });
            this.unsubscribe();
        }
        ...
        value: function handleScroll() {
            ...
            var newNailArray = _extends([], this.nailArray);
